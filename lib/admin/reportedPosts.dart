...
class ReportedPosts extends StatefulWidget {
  const ReportedPosts({super.key});

  @override
  State<ReportedPosts> createState() => _ReportedPosts();
}

// This Page will show The User Donations
class _ReportedPosts extends State<ReportedPosts> {
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        snapshot.data!.docs[index]['postedDate']
                                            .toString(),
                                      ),
                                    ],
                                  ),
